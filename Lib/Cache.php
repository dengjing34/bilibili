...
class Cache {
    ...
    /**
     * 是否强制刷新
     * @return boolean true则不读取memcache数据, false则读取
     */
    ...
    public function get($key) {
        return $this->forceRefresh() ? false : $this->getMemcached()->get($key);
    }
    ...
    public function getMulti(array $keys) {
        $null = null;
        return $this->forceRefresh() ? array_fill_keys($keys, null) : $this->getMemcached()->getMulti($keys, $null, \Memcached::GET_PRESERVE_ORDER);
    }
    ...
    public function decrement($key, $offset = 1) {
        return $this->getMemcached()->decrement($key, (int)$offset);
    }
    ...
    public function flush($time = 0) {
        return $this->getMemcached()->flush($time);
    }
